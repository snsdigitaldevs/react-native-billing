...
public class InAppBilling implements ActivityEventListener, BillingProcessor.IBillingHandler {
    ...
    public InAppBilling(ReactApplicationContext reactContext, String licenseKey) {
    ...
    public void purchase(final String productId, final String developerPayload, final Activity activity, final Promise promise){
        if (bp != null) {
            if (putPromise(PromiseConstants.PURCHASE_OR_SUBSCRIBE, promise)) {
                boolean purchaseProcessStarted = bp.purchase(activity, productId, developerPayload);
    ...
    public void subscribe(final String productId, final String developerPayload, final Activity activity, final Promise promise){
        if (bp != null) {
            if (putPromise(PromiseConstants.PURCHASE_OR_SUBSCRIBE, promise)) {
                boolean subscribeProcessStarted = bp.subscribe(activity, productId, developerPayload);
    ...
    public void updateSubscription(final ReadableArray oldProductIds, final String productId, final String developerPayload, final Activity activity, final Promise promise){
        if (bp != null) {
            if (putPromise(PromiseConstants.PURCHASE_OR_SUBSCRIBE, promise)) {
                ...
                boolean updateProcessStarted = bp.updateSubscription(activity, oldProductIdList, productId, developerPayload);
